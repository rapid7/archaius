...
import com.netflix.proplog.config.DynamicLongProperty;
...
public abstract class AbstractDynamoDbConfigurationSource <T> {
    ...
    //Property names
    static final String tablePropertyName = "com.netflix.proplog.config.dynamo.tableName";
    static final String keyAttributePropertyName = "com.netflix.proplog.config.dynamo.keyAttributeName";
    static final String valueAttributePropertyName = "com.netflix.proplog.config.dynamo.valueAttributeName";
    static final String endpointPropertyName = "com.netflix.proplog.config.dynamo.endpoint";
    static final String pollingMaxBackOffMsPropertyName = "com.netflix.proplog.config.dynamo.maxPollingBackOffMs";
    static final String pollingMinBackOffMsPropertyName = "com.netflix.proplog.config.dynamo.maxPollingBackOffMs";
    static final String maxRetryCountPropertyName = "com.netflix.proplog.config.dynamo.maxRetryCount";

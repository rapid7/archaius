...
import com.netflix.proplog.config.DeploymentContext;
import com.netflix.proplog.config.DynamicPropertyFactory;
import com.netflix.proplog.config.DynamicStringProperty;
import com.netflix.proplog.config.PropertyWithDeploymentContext;
...
public class DynamoDbDeploymentContextTableCache extends AbstractDynamoDbConfigurationSource<PropertyWithDeploymentContext> {
    ...
    //Property names
    static final String contextKeyAttributePropertyName = "com.netflix.proplog.config.dynamo.contextKeyAttributeName";
    static final String contextValueAttributePropertyName = "com.netflix.proplog.config.dynamo.contextValueAttributeName";

...
import com.netflix.proplog.config.*;
...
public class DynamoBackedConfigurationIntegrationTest {
    ...
    public static void setUpClass() throws Exception {
        ...
        System.setProperty("com.netflix.proplog.config.dynamo.tableName", tableName);
        if (dbClient != null) {
            DynamoDbIntegrationTestHelper.createTable(dbClient, tableName);
            DynamoDbIntegrationTestHelper.addElements(dbClient, tableName);
        }
    }

    @AfterClass
    public static void tearDownClass() throws Exception {
        if (dbClient != null) DynamoDbIntegrationTestHelper.removeTable(dbClient, tableName);
    }
    ...
    public void testPropertyChange() throws Exception{
        ...
        if (dbClient != null) {
            ...
            DynamoDbIntegrationTestHelper.updateValues(dbClient, tableName);
            Thread.sleep(5000);

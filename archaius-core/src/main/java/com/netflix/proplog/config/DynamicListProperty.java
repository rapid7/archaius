...
public abstract class DynamicListProperty<T> implements Property<List<T>> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DynamicListProperty.class);
    ...
    private void setup(String propName, List<T> defaultValue, Splitter splitter) {
        ...
        logger.info("CONSUMED PROPERTY (class, name, default): '" + this.getClass() + "', '" + propName + "', '" + defaultValue + "'");

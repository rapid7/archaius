...
import com.netflix.proplog.config.validation.PropertyChangeValidator;
import com.netflix.proplog.config.validation.ValidationException;
...
public abstract class PropertyWrapper<V> implements Property<V> {
    ...
    protected PropertyWrapper(String propName, V defaultValue) {
        ...
        Class<?> c = getClass();
        logger.info("CONSUMED PROPERTY (class, name, default): '" + c + "', '" + propName + "', '" + defaultValue + "'");

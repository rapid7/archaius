...
import com.netflix.proplog.config.DynamicIntProperty;
import com.netflix.proplog.config.DynamicStringProperty;
import com.netflix.proplog.config.jmx.ConfigJMXManager;
import com.netflix.proplog.config.jmx.ConfigMBean;
...
public class SampleApplication extends Thread {
	...
	public static void main(String[] args) {
		...
		myConfiguration.setProperty(
				"com.netflix.proplog.config.samples.SampleApp.SampleBean.name",
...
class SampleBean {
	...
	public DynamicIntProperty numSeeds = DynamicPropertyFactory.getInstance()
			.getIntProperty(
					"com.netflix.proplog.config.samples.SampleApp.SampleBean.numSeeds",
					2);
	...
	DynamicStringProperty sensitiveBeanData = DynamicPropertyFactory
			.getInstance()
			.getStringProperty(
					"com.netflix.proplog.config.samples.SampleApp.SampleBean.sensitiveBeanData",
					"magic", new Runnable() {
						public void run() {

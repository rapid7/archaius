 ...
 */
package com.netflix.proplog.config.samples;


import com.netflix.proplog.config.ConcurrentCompositeConfiguration;
import com.netflix.proplog.config.ConcurrentMapConfiguration;
...
public class SampleApplicationWithDefaultConfiguration {
    static {
        ...
        System.setProperty("com.netflix.proplog.config.samples.SampleApp.SampleBean.sensitiveBeanData", "value from system property");
    }
    ...
    public static void main(String[] args) {
        ...
        subConfig.setProperty("com.netflix.proplog.config.samples.SampleApp.SampleBean.name", "A Coffee Bean from Cuba");
        myConfiguration.setProperty("com.netflix.proplog.config.samples.sampleapp.prop1", "value1");
        ...
        System.out.println("To see how callback work, update property com.netflix.proplog.config.samples.SampleApp.SampleBean.sensitiveBeanData from BaseConfigBean in JConsole");
        
        SampleBean sampleBean = new SampleBean();
        // this should show the bean taking properties from two different sources
        // property "com.netflix.proplog.config.samples.SampleApp.SampleBean.numSeeds" is from sampleapp.properites
        // property "com.netflix.proplog.config.samples.SampleApp.SampleBean.name" is from subConfig added above

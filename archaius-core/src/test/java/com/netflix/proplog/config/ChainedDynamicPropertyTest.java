 ...
 */
package com.netflix.proplog.config;
...
public class ChainedDynamicPropertyTest {
    ...
    public void testBoolean() throws Exception {
        ...
        ChainedDynamicProperty.DynamicBooleanPropertyThatSupportsNull pBoolean = new ChainedDynamicProperty.DynamicBooleanPropertyThatSupportsNull("defaultBoolean", Boolean.FALSE);
    ...
    public void testChainingString() throws Exception {
        ...
        ChainedDynamicProperty.StringProperty node2 = new ChainedDynamicProperty.StringProperty("node2", node1);
    ...
    public void testChainingInteger() throws Exception {
        ...
        ChainedDynamicProperty.IntProperty node2 = new ChainedDynamicProperty.IntProperty("node2", node1);

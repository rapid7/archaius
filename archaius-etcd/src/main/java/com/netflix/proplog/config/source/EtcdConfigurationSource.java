package com.netflix.proplog.config.source;
...
import com.netflix.proplog.config.WatchedConfigurationSource;
import com.netflix.proplog.config.WatchedUpdateListener;
import com.netflix.proplog.config.WatchedUpdateResult;
        ...
        public void handle(Response updateResponse) {
            ...
            if (node != null ) {
                ...
                switch (action) {
                    case "create":
                        valueCache.put(sourceKey, value);
                        updateConfiguration(WatchedUpdateResult.createIncremental(null, ImmutableMap.<String, Object>of(sourceKey, value), null));
                        break;

                    case "set":
                        valueCache.put(sourceKey, value);
                        updateConfiguration(WatchedUpdateResult.createIncremental(ImmutableMap.<String, Object>of(sourceKey, value), null, null));
                        break;

                    case "delete":
                        valueCache.remove(sourceKey);
                        updateConfiguration(WatchedUpdateResult.createIncremental(null, null, ImmutableMap.<String, Object>of(sourceKey, "")));
                        break;

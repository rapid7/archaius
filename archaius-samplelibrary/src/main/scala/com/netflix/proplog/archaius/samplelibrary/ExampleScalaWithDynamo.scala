...
import DynamoDbConfigurationSource
...
class ExampleScalaWithDynamo extends ExampleScala {
    ...
     finalConfig.setProperty("com.netflix.proplog.config.dynamo.tableName", tableName)
     finalConfig.setProperty("com.netflix.proplog.config.dynamo.keyAttributeName", DynamicPropertyConstants.KeyAttributeName)
     finalConfig.setProperty("com.netflix.proplog.config.dynamo.valueAttributeName", DynamicPropertyConstants.ValueAttributeName)
    ...
       finalConfig.getProperty("com.netflix.proplog.config.dynamo.tableName"),
       finalConfig.getProperty("com.netflix.proplog.config.dynamo.keyAttributeName"),
       finalConfig.getProperty("com.netflix.proplog.config.dynamo.valueAttributeName"))

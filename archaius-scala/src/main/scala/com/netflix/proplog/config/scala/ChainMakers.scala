 ...
 */
package com.netflix.proplog.config.scala

import ChainedDynamicProperty.ChainLink
import Property

/**
 * Utilities for assembling the chains of dynamic properties underlying a [[com.netflix.proplog.config.scala.ChainedProperty]].
 */
protected[scala] object ChainMakers {
  ...
  /**
   * Create the [[ChainedDynamicProperty.ChainLink]]s which underpin a [[com.netflix.proplog.config.scala.ChainedProperty]], properly related.
   *
   ...
   * @param rootWrap      a function to create the [[ChainedDynamicProperty.ChainLink]] which contains the root [[PropertyWrapper]].
   * @param linkWrap      a function to create all [[ChainedDynamicProperty.ChainLink]]s which contain another [[ChainedDynamicProperty.ChainLink]].
   * @tparam T            the type of the value which the chain returns.
   * @tparam PWT          the type of the root PropertyWrapper of the chain.
   * @tparam CLT          the type of all [[ChainedDynamicProperty.ChainLink]]s in the chain.
   * @return              a [[ChainedDynamicProperty.ChainLink]] which represents the most specific property, containing all other [[ChainedDynamicProperty.ChainLink]]s.
   */

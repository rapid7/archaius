...
import com.netflix.proplog.config.scala.ChainMakers.ChainBox
import com.netflix.proplog.config.{ChainedDynamicProperty, DynamicPropertyFactory}
import com.netflix.proplog.config.{DynamicFloatProperty => JavaDynamicFloatProperty}
...
extends ChainedProperty[Float]
{
  ...
  override protected val box =  new ChainBox[Float, java.lang.Float] {
     ...
     * The value is guaranteed to be non-null thanks to [[com.netflix.proplog.config.scala.ChainMakers.ChainBox.nonNull]].
